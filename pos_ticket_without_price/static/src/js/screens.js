...
odoo.define("pos_ticket_without_price.screens", function (require) {
    ...
    screens.ReceiptScreenWidget.include({
        renderElement: function () {
            ...
            var button_print_ticket_without_price = this.$(
                ".button.print_ticket_without_price"
            );
        ...
        render_ticket_without_price: function () {
            this.$(".pos-receipt-container").html(
                QWeb.render("PosTicketWithoutPrice", this.get_receipt_render_env())
            );
        },
    });
});
