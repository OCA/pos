        ...
        set_smart_status: function (status) {
            ...
            if (status.status === "connected") {
                ...
                if (this.pos.config.iface_automatic_cashdrawer) {
                    var automatic_cashdrawer = status.drivers.automatic_cashdrawer
                        ? status.drivers.automatic_cashdrawer.status
                        : false;
    ...
    */
    ...
    var AutomaticCashdrawerAdminDialog = PopupWidget.extend({
                ...
                .then(function () {
                    self.gui.show_popup("cashdrawer_cash_in", {
                        ...
                        confirm: function (value) {
                            self.pos
                                .action_put_money_in(value, _t("Manual: put money in"))
                                .then(function (st_line) {
                                    self.pos.proxy.print_receipt(
                                        QWeb.render(
                ...
                .then(function () {
                    self.gui.show_popup("number", {
                        ...
                        confirm: function (value) {
                            ...
                            framework.blockUI();
                            self.pos.proxy
                                .automatic_cashdrawer_dispense(value)
                                .then(function (res) {
                                    var print_lines = [];
                                    // Handling
                                    if (res != value) {
                                        ...
                                        print_lines.push(
                                            _t(
                                                "The requested amount to dispense was: "
                                            ) +
                                                value +
                                                _t(" but the dispensed amount was: ") +
                                                res
                                        );
                                        // Show error popup
                                        self.gui.show_popup("error", {
                                            title: _t(
                                                "Could not dispense the value requested"
                                            ),
                                            body:
                                                _t(
                                                    "The requested amount to dispense was: "
                                                ...
                                                value +
                                                "<br/>" +
                                                _t("The dispensed amount was: ") +
                                                res,
                                        });
                                    }
                                    // Register accounting
                                    self.pos
                                        .action_take_money_out(
                                            res,
                                            _t("Manual: take money out")
                                        )
                                        .then(function (st_line) {
                                            print_lines.push(
                                                _t("Dispensed: ") +
                                                    self.format_currency(res)
                                            );
                                            self.pos.proxy.print_receipt(
                                                QWeb.render(
                                                    "AutomaticCashdrawerActionXmlReport",
        ...
        action_cancel: function () {
            ...
            this.pos.proxy.automatic_cashdrawer_stop_acceptance().then(function (res) {
                self.pos.proxy.print_receipt(
                    QWeb.render("AutomaticCashdrawerActionXmlReport", {
                        pos: self.pos,
                        report: {
        ...
        action_close_till: function () {
            ...
            this.pos
                ...
                .then(function () {
                    self.pos.proxy
                        .automatic_cashdrawer_display_close_till()
                        .then(function (res) {
                            if (res.added) {
                                self.pos
                                    .action_put_money_in(
                            ...
                            if (res.dispensed) {
                                self.pos
                                    .action_take_money_out(
                                        res.dispensed,
                                        _t(
                                            "Automatic Cashdrawer: Close Till / DISPENSED"
                                        )
                                    )
                                    .then(function (st_line) {
                                        self.pos.proxy.print_receipt(
        ...
        action_empty_stacker: function () {
            ...
            this.pos
                ...
                .then(function () {
                    self.pos.proxy
                        .automatic_cashdrawer_display_empty_stacker()
                        .then(function (res) {
                            if (res) {
                                self.pos
                                    .action_take_money_out(
        ...
        action_complete_emptying: function () {
            ...
            this.pos
                ...
                .then(function () {
                    self.pos.proxy
                        .automatic_cashdrawer_display_complete_emptying()
                        .then(function (res) {
                            if (res) {
                                self.pos
                                    .action_take_money_out(
            ...
            this.pos.check_opening_balance_missing().then(function (res) {
                if (res === true) {
                    self.pos.proxy
                        ...
                        .then(function (res) {
                            self.pos
                                .action_set_balance(res.total, "start")
                                .then(function (res) {
    ...
    var AutomaticCashDrawerCashInDialog = PopupWidget.extend({
        ...
        show: function (options) {
            ...
            if (options.payment) {
                this.pos.proxy
                    .automatic_cashdrawer_start_acceptance()
                    .then(function (res) {
                        self.update_counter();
                    })
                    .fail(function (err) {
                ...
                this.pos.proxy
                    .automatic_cashdrawer_start_add_change()
                    .then(function (res) {
                        self.update_counter();
                    })
                    .fail(function (err) {
        ...
        update_counter: function () {
            ...
            this.pos.proxy
                ...
                .then(function (res) {
                    ...
                    if (
                        self.options.to_collect &&
                        self.options.auto_accept &&
                        self.inputbuffer >= self.options.to_collect
                    ) {
        ...
        click_confirm: function () {
            var self = this;
            this.pos.proxy
                .automatic_cashdrawer_stop_acceptance()
                .then(function (value) {
                    if (self.options.to_collect && value >= self.options.to_collect) {
                        var change = utils.round_precision(
                            value - self.options.to_collect,
                            self.pos.currency.rounding
                        );
                        if (change > 0) {
                            // More was collected, we dispense
                            self.pos.proxy
                                .automatic_cashdrawer_dispense(change)
                                .then(function (res) {
                                    if (self.options.confirm) {
                                        self.options.confirm.call(
                                            self,
                                            value - change,
                                            value,
                                            change
    ...
    gui.define_popup({
        name: "cashdrawer_admin",
        widget: AutomaticCashdrawerAdminDialog,
    });
    gui.define_popup({
        name: "cashdrawer_cash_in",
        widget: AutomaticCashDrawerCashInDialog,
    });
    ...
    var AutomaticCashdrawerInventoryDialog = PopupWidget.extend({
        ...
        show: function (options) {
            ...
            $.when(
                ...
                .then(function (totals, inventory) {
                    ...
                    self.sorted_values = Object.keys(self.inventory.total).sort(
                        function (a, b) {
        ...
        click_confirm: function () {
            this.pos.proxy.print_receipt(
                QWeb.render("AutomaticCashdrawerInventoryXmlReport", {
                    widget: this,
                    pos: this.pos,
                    report: {
                        totals: this.totals,
    ...
    gui.define_popup({
        name: "cashdrawer_inventory",
        widget: AutomaticCashdrawerInventoryDialog,
    });
