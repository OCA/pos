...
class TestPosSession(TransactionCase):
    ...
    def test__loader_params_product_product_with_available_product(self):
        ...
        self.assertIn(('product_tmpl_id', 'in', self.pos_config_1.available_product_ids.ids), result['search_params']['domain'])
    ...
    def test__loader_params_product_product_without_available_product(self):
        ...
        self.assertNotIn(('product_tmpl_id', 'in', self.pos_config_1.available_product_ids.ids), result['search_params']['domain'])