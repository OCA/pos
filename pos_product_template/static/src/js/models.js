...
odoo.define("pos_product_template.models", function(require){
    ...
    PosDB.include({
        ...
        add_product_template_attribute_values: function(product_template_attribute_values){
            product_template_attribute_values.forEach(attribute_value => {
                this.product_template_attribute_value_by_id[attribute_value.id] = attribute_value;
            });
        },
