...
const PPTProductItem = (ProductItem) =>
    class extends ProductItem {
        setup() {
            ...
            } else if (this.props.product.product_variant_count > 1) {
                useListener("click", this.onClick);
                // Core.qweb.render("ProductTemplateItem", {product: this.props.product}); //no encuentra la vista
                // ProductItem.template = "ProductTemplateItem"; //salta error pero no pone cual
