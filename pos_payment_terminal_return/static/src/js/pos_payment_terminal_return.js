...
odoo.define(
    "pos_payment_terminal_return.pos_payment_terminal_return",
    function (require) {
        "use strict";
        ...
        models.Paymentline = models.Paymentline.extend({
            wait_terminal_return: function () {
                if (
                    this.cashregister.journal.pos_terminal_payment_mode === "card" &&
                    this.pos.config.iface_payment_terminal &&
