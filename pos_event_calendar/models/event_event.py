...
class EventEvent(models.Model):
    ...
    def _load_pos_data_fields(self, config_id):
        ...
        super(EventEvent, self)._load_pos_data_fields(config_id)
        return [
            'id',
            'name',
            'date_begin',
...
class EventEventTicket(models.Model):
    ...
    def _load_pos_data_fields(self, config_id):
        """Specify which fields to load in the POS"""
        super(EventEventTicket, self)._load_pos_data_fields(config_id)
        return [
            'name',
            'event_id',
            'product_id',
...
class EventTag(models.Model):
    ...
    def _load_pos_data_fields(self, config_id):
        """Specify which fields to load in the POS"""
        super(EventTag, self)._load_pos_data_fields(config_id)
        return [
            'name',
        ]