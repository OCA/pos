    ...
    })(
        {
                ...
                function (a, b, c) {
                    ...
                    (b.exports = e),
                        ...
                        (e.prototype.then = function (a, b) {
                            if (
                                (typeof a !== "function" && this.state === r) ||
                                (typeof b !== "function" && this.state === q)
                            )
                                return this;
                        ...
                        (p.resolve = function (a, b) {
                            var c = j(h, b);
                            if (c.status === "error") return p.reject(a, c.value);
                            var d = c.value;
                            if (d) i(a, d);
                            else {
            ...
            4: [
                function (a, b, c) {
                    ...
                    function i(a, b, c) {
                        typeof b === "function" && a.then(b),
                            typeof c === "function" && a.catch(c);
                    }
                    function j(a) {
                        return (
                            typeof a !== "string" &&
                        ...
                        if (
                            ...
                            a &&
                                (c === "[object ArrayBuffer]" ||
                                    (a.buffer &&
                                        Ua.call(a.buffer) === "[object ArrayBuffer]")))
                        ) {
                            var d,
                                e = Ga;
                    ...
                    function S(a) {
                        ...
                        if (a)
                            for (var d in a)
                                c[d] = typeof a[d] !== "string" ? a[d].toString() : a[d];
                    ...
                    function ea(a, b) {
                        var c = a.name + "/";
                        return (
                            a.storeName !== b.storeName && (c += a.storeName + "/"), c
                        );
                    }
                    function fa() {
                        ...
                        var b = this,
                            c = b.ready().then(function () {
                                for (
                                    ...
                                    d.indexOf(a) === 0 && localStorage.removeItem(d);
                                }
                            });
                        return h(c, a), c;
                    }
                                ...
                                (a.prototype.defineDriver = function (a, b, c) {
                                    var d = new va(function (b, c) {
                                        try {
                                            ...
                                            "_support" in a
                                                ? a._support &&
                                                  typeof a._support === "function"
                                                    ? a._support().then(k, c)
                                                    : k(Boolean(a._support))
                                                : k(!0);
                                        } catch (a) {
                                            c(a);
                                        }
