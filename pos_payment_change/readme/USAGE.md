...
![pos_order_form](../static/description/pos_order_form.png)

- In the pop up wizard, select the real payment(s) that have been used
  to pay the order

![pos_payment_change_wizard_form](../static/description/pos_payment_change_wizard_form.png)
...
![pos_order_tree](../static/description/pos_order_tree.png)
