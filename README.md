...
[pos_partner_birthdate](pos_partner_birthdate/) | 16.0.1.0.3 | [![ecino](https://github.com/ecino.png?size=30px)](https://github.com/ecino) | Adds the birthdate in the customer screen of POS
