...
[pos_cashback_warning](pos_cashback_warning/) | 12.0.1.0.2 | [![legalsylvain](https://github.com/legalsylvain.png?size=30px)](https://github.com/legalsylvain) | Point of Sale - Cashback Warning
...
[pos_margin_accounting_role](pos_margin_accounting_role/) | 12.0.1.0.0 | [![jumeldi74](https://github.com/jumeldi74.png?size=30px)](https://github.com/jumeldi74) | Margin on PoS Order for Accounting Role
[pos_meal_voucher](pos_meal_voucher/) | 12.0.1.0.8 | [![legalsylvain](https://github.com/legalsylvain.png?size=30px)](https://github.com/legalsylvain) | Handle meal vouchers in Point of Sale with eligible amount and max amount
