...
[pos_prevent_double_closing](pos_prevent_double_closing/) | 12.0.1.0.1 |  | Prevent user to generate duplicates of accounting sale entries, when double closing sessions.
